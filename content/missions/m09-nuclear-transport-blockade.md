---
title: "Nuclear Transport Blockade"
metaTitle: "Nuclear Transport Blockade - Airforce Delta Strategy Guide Wiki"
metaDescription: "Mission 9 - Nuclear Transport Blockade"
---
...
<table id="targetList" class="pageLinksTable">
  <tr>
    <td class ="tableImage" colspan="2"><img src="../images/mission_thumb/m9_thumb.png"/></td>
  </tr>
  <tr>
    <td>Location</td>
    <td>Uranium Mine</td>
  ...
  <tr>
    <td>Objective</td>
    <td>Destroy all <span class="redText">targets</span> before they escape from the battle zone</td>
  </tr>
  <tr>
    <td>Time Limit</td>
    <td>10 Minutes</td>
...
<div class="missionBriefingMapImage">
  <img src="../images/mission_map/m9_map_large.png"/>
</div>
...
<div class="mapImage">
  <img src="../images/mission_map/m9_map.png"/>
</div>

# Enemy List
|Name|Type|Quantity|Score|
|-|-|-|-|
|Train|<span class="redText">Target - Ground</span>|4|10,000|
|DORA|<span class="redText">Target - Ground</span>|2|10,000|
