---
title: "Federation Fleet Obstruction"
metaTitle: "Federation Fleet Obstruction - Airforce Delta Strategy Guide Wiki"
metaDescription: "Mission 2 - Federation Fleet Obstruction"
---
...
<table id="targetList" class="pageLinksTable">
  <tr>
    <td class ="tableImage" colspan="2"><img src="../images/mission_thumb/m2_thumb.png"/></td>
  </tr>
  <tr>
    <td>Location</td>
  ...
  <tr>
    <td>Objective</td>
    <td>Sink all <span class="redText">destroyers and aircraft carriers</span></td>
  </tr>
  <tr>
    <td>Time Limit</td>
    <td>7 Minutes</td>
...
<div class="missionBriefingMapImage">
  <img src="../images/mission_map/m2_map_large.png"/>
</div>
...
<div class="mapImage">
  <img src="../images/mission_map/m2_map.png"/>
</div>

# Enemy List
|Name|Type|Quantity|Score|
|-|-|-|-|
|Destroyer|<span class="redText">Target - Sea</span>|3|12,000|
|Carrier|<span class="redText">Target - Sea</span>|3|22,000|
